	...
	return /******/ (() => {
				...
				var Rive = (() => {
					...
					return function (moduleArg = {}) {
						...
						k.onRuntimeInitialized = function () {
							...
							k.CustomFileAssetLoader = c.extend(
							...
							k.FallbackFileAssetLoader = c.extend(
							...
							function b(q, u = !1) {
								...
								z.delete = function () {
									...
									"object" == typeof JSEvents &&
										JSEvents.Oc(w[H].C.canvas);
									w[H] &&
										w[H].C.canvas &&
										(w[H].C.canvas.zb = void 0);
									this.Ka =
										this.F =
										this.La =
										this.T =
							...
							function c() {
								if (d) {
									var q = d.Cb,
										...
										H = 0;
									for (var I of e) {
										(I.ga = Math.min(I.F.width, q)),
											(I.fa = Math.min(I.F.height, q)),
											(I.Ia = I.fa * I.ga),
											(u = Math.max(u, I.ga)),
											(y = Math.max(y, I.fa)),
											(z += I.Ia),
							...
							k.makeRenderer = function (q, u) {
								if (!d) {
									function y(z) {
										...
										A.height = 1;
										d = b(A, z);
										d.Va = !!d.T.getExtension(
											"WEBGL_shader_pixel_local_storage",
										);
										d.Cb = Math.min(
											d.T.getParameter(
												d.T.MAX_RENDERBUFFER_SIZE,
											),
											d.T.getParameter(
												d.T.MAX_TEXTURE_SIZE,
											),
										);
										d.Ja = !d.Va;
										if (
											...
											(A = d.T.getParameter(
												z.UNMASKED_RENDERER_WEBGL,
											)),
												d.T.getParameter(
													z.UNMASKED_VENDOR_WEBGL,
												).includes("Google") &&
													A.includes(
						...
						var qa = k.print || console.log.bind(console),
							ra = k.printErr || console.error.bind(console);
						Object.assign(k, ka);
						ka = null;
							...
							Ua = {
								...
								519112: (a, b, c, d, e, f) => {
									...
									a == window.h.I.Ba &&
										0 != c &&
										(l.sampleRate = c);
									g.J = new (window.AudioContext ||
										window.webkitAudioContext)(l);
									g.J.suspend();
									...
									g.Z.onaudioprocess = function (p) {
										...
										if (
											a == window.h.I.capture ||
											a == window.h.I.Na
										) {
											for (var m = 0; m < b; m += 1) {
												for (
													var t =
															p.inputBuffer.getChannelData(
																m,
															),
														v = g.wa,
														x = 0;
										...
										if (
											...
											for (
												Ta(f, d, e), m = 0;
												m <
												p.outputBuffer.numberOfChannels;
												++m
											) {
												for (
													t =
								...
								521989: (a) => window.h.va(a).J.sampleRate,
								522062: (a) => {
									a = window.h.va(a);
									void 0 !== a.Z &&
										((a.Z.onaudioprocess = function () {}),
										a.Z.disconnect(),
										(a.Z = void 0));
									void 0 !== a.Ea &&
										(a.Ea.disconnect(), (a.Ea = void 0));
									a.J.close();
									a.J = void 0;
									a.lb = void 0;
								},
						...
						function nb(a, b) {
							...
							c >= b ||
								((b = Math.max(
									b,
									(c * (1048576 > c ? 2.0 : 1.125)) >>> 0,
								)),
								0 != c && (b = Math.max(b, 256)),
								(c = a.j),
								(a.j = new Uint8Array(b)),
								0 < a.v && a.j.set(c.subarray(0, a.v), 0));
						}
						var O = {
							O: null,
							U() {
							...
							createNode(a, b, c, d) {
								...
								a &&
									((a.j[b] = c), (a.timestamp = c.timestamp));
								return c;
							},
							Bc(a) {
								return a.j
						...
						function xc(a, b) {
							(b.u && b.o) ||
								wc("makeClassHandle requires ptr and ptrType");
							!!b.L !== !!b.H &&
								wc(
						...
						function V(a, b, c) {
							function d(l) {
								l = c(l);
								l.length !== a.length &&
									wc("Mismatched type converter count");
							...
							if (void 0 === a[b].B) {
								...
								a[b] = function () {
									a[b].B.hasOwnProperty(arguments.length) ||
										R(
											`Function '${c}' called with an invalid number of arguments (${arguments.length}) - expects one of (${a[b].B})!`,
										);
									return a[b].B[arguments.length].apply(
										this,
										arguments,
									);
								};
						...
						function Mc(a, b) {
							if (null === b) {
								return (
									this.Pa &&
										R(`null is not a valid ${this.name}`),
									0
								);
							}
							b.g ||
								R(`Cannot pass "${Nc(b)}" as a ${this.name}`);
							b.g.o ||
								R(
						...
						function Oc(a, b) {
							...
							!this.xa &&
								b.g.u.xa &&
								R(
									`Cannot convert argument of type ${b.g.L ? b.g.L.name : b.g.u.name} to parameter type ${this.name}`,
								);
						...
						function Pc(a, b) {
							...
							b.g.u.xa &&
								R(
									`Cannot convert argument of type ${b.g.u.name} to parameter type ${this.name}`,
								);
							return Lc(b.g.o, b.g.u.i, this.i);
						}
						function Qc(a, b, c, d) {
							...
							void 0 !== b.A
								? (this.toWireType = Oc)
								: ((this.toWireType = d ? Mc : Pc),
									(this.K = null));
						}
						function Rc(a, b, c) {
							k.hasOwnProperty(a) ||
								wc("Replacing nonexistant public symbol");
							void 0 !== k[a].B && void 0 !== c
								? (k[a].B[c] = b)
								: ((k[a] = b), (k[a].ha = c));
						}
						var Sc = [],
						...
						function Xc(a, b, c, d, e) {
							...
							return function () {
								arguments.length !== m &&
									R(
										`function ${a} called with ${arguments.length} arguments, expected ${m} args!`,
									);
								x.length = 0;
								v.length = g ? 2 : 1;
								v[0] = e;
						...
						function Fd(a) {
							...
							if (!a.Vb) {
								...
								Gd(b);
								(b.getSupportedExtensions() || []).forEach(
									function (c) {
						...
						var Qd = (a) =>
							...
							Td = (a, b, c, d) => {
								...
								m = {
									"%a": (n) => v[n.R].substring(0, 3),
									"%A": (n) => v[n.R],
									"%b": (n) => x[n.Ha].substring(0, 3),
									"%B": (n) => x[n.Ha],
									"%C": (n) =>
										f(((n.ea + 1900) / 100) | 0, 2),
									"%d": (n) => f(n.Ta, 2),
									...
									"%n": () => "\n",
									"%p": (n) =>
										0 <= n.Ga && 12 > n.Ga ? "AM" : "PM",
									"%S": (n) => f(n.mc, 2),
									"%t": () => "\t",
									"%u": (n) => n.R || 7,
									"%U": (n) =>
										f(Math.floor((n.da + 7 - n.R) / 7), 2),
									"%V": (n) => {
										var q = Math.floor(
											(n.da + 7 - ((n.R + 6) % 7)) / 7,
										);
									...
									"%y": (n) =>
										(n.ea + 1900).toString().substring(2),
									"%Y": (n) => n.ea + 1900,
									"%z": (n) => {
										n = n.kc;
										var q = 0 <= n;
						...
						Hc.prototype["delete"] = function () {
							...
							rc(this.g);
							this.g.ka ||
								((this.g.H = void 0), (this.g.o = void 0));
						};
						...
						var Yd = {
							...
							_embind_create_inheriting_constructor: function (
								...
								f.__construct = function () {
									this === f &&
										R("Pass correct 'this' to __construct");
									var m = l.implement.apply(
										void 0,
									...
									ic.hasOwnProperty(m)
										? R(
												`Tried to register registered instance: ${m}`,
											)
										: (ic[m] = this);
								};
								f.__destruct = function () {
									this === f &&
										R("Pass correct 'this' to __destruct");
									pc(this);
									var m = this.g.o;
									m = jc(e, m);
									ic.hasOwnProperty(m)
										? delete ic[m]
										: R(
												`Tried to unregister unregistered instance: ${m}`,
											);
								};
							...
							_embind_register_class: function (
								...
								Jc(n, function () {
									Wc(
										`Cannot construct ${t} due to unbound types`,
										[d],
									);
								});
								V([a, b, c], d ? [d] : [], function (q) {
									...
									q = $b(n, function () {
										...
										if (void 0 === I) {
											throw new bc(
												`Tried to invoke ctor of ${t} with invalid number of parameters (${arguments.length}) - expected (${Object.keys(A.$).toString()}) parameters instead!`,
											);
										}
							...
							_embind_register_class_class_function: function (
								...
								V([], [a], function (p) {
									...
									void 0 === v[b]
										? ((m.ha = c - 1), (v[b] = m))
										: (Ic(v, b, t), (v[b].B[c - 1] = m));
									V([], l, function (x) {
										x = Xc(
											t,
											[x[0], null].concat(x.slice(1)),
											null,
											f,
											g,
										);
								...
								V([], [a], function (p) {
									...
									var m = `${p.name}.${b}`,
										t = {
											get() {
												Wc(
													`Cannot access ${m} due to unbound types`,
													[c],
												);
											},
											enumerable: !0,
							...
							_embind_register_class_constructor: function (
								...
								V([], [a], function (l) {
									...
									if (void 0 !== l.i.$[b - 1]) {
										throw new bc(
											`Cannot register multiple constructors with identical number of parameters (${b - 1}) for class '${l.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`,
										);
									}
									l.i.$[b - 1] = () => {
										Wc(
											`Cannot construct ${l.name} due to unbound types`,
											g,
										);
									};
									V([], g, function (m) {
							...
							_embind_register_class_function: function (
								...
								V([], [a], function (m) {
									function t() {
										Wc(
											`Cannot call ${v} due to unbound types`,
											p,
										);
									}
									m = m[0];
							...
							_emval_get_method_caller: function (a, b) {
								...
								e = od((g, l, p, m) => {
									for (var t = 0, v = 0; v < a - 1; ++v) {
										(f[v] = c[v + 1].readValueFromPointer(
											m + t,
										)),
											(t += c[v + 1].argPackAdvance);
									}
									g = g[l].apply(g, f);
									for (v = 0; v < a - 1; ++v) {
							...
							beginPixelLocalStorageWEBGL: function (a, b, c) {
								(a = w[a].C.ca) &&
									a.beginPixelLocalStorageWEBGL(
										k.HEAPU32.subarray(c, c + b),
									);
							},
							...
							emscripten_webgl_make_context_current: function (
								a,
							) {
								return ja(a) ? 0 : -5;
							},
							...
							framebufferPixelLocalClearValuefvWEBGL: function (
								...
								(a = w[a].C.ca) &&
									a.framebufferPixelLocalClearValuefvWEBGL(
										b,
										[c, d, e, f],
									);
							},
							framebufferTexturePixelLocalStorageWEBGL: function (
								...
								(a = w[a].C.ca) &&
									a.framebufferTexturePixelLocalStorageWEBGL(
										b,
										zd[c],
										d,
										e,
							...
							getFramebufferPixelLocalStorageParameterivWEBGL:
								function (a, b, c) {
									return (a = w[a].C.ca)
										? a.getFramebufferPixelLocalStorageParameterWEBGL(
												b,
												c,
											)
										: 0;
							...
							glGetUniformLocation: function (a, b) {
								...
								if ((a = wd[a])) {
									...
									if (!d) {
										for (
											c.oa = d = {}, c.ub = {}, f = 0;
											f < Z.getProgramParameter(c, 35718);
											++f
										) {
							...
							strftime_l: (a, b, c, d) => Td(a, b, c, d),
							upload_image: function (a, b) {
								var c = k.images;
								c &&
									(b = c.get(b)) &&
									((a = w[a].C),
						...
						var nc = (a) => (nc = C.free)(a),
							Nd = (a) => (Nd = C.malloc)(a);
						k._setWebImage = (a, b, c) =>
							(k._setWebImage = C.setWebImage)(a, b, c);
						var Ra = (k._ma_device__on_notification_unlocked = (
							a,
						) =>
							(Ra = k._ma_device__on_notification_unlocked =
								C.ma_device__on_notification_unlocked)(a));
						k._ma_malloc_emscripten = (a, b) =>
							(k._ma_malloc_emscripten = C.ma_malloc_emscripten)(
								a,
								b,
							);
						k._ma_free_emscripten = (a, b) =>
							(k._ma_free_emscripten = C.ma_free_emscripten)(
								a,
								b,
							);
						var Sa =
								(k._ma_device_process_pcm_frames_capture__webaudio =
									(a, b, c) =>
										(Sa =
											k._ma_device_process_pcm_frames_capture__webaudio =
							...
							Ta =
								(k._ma_device_process_pcm_frames_playback__webaudio =
									(a, b, c) =>
										(Ta =
											k._ma_device_process_pcm_frames_playback__webaudio =
							...
							Xd = () => (Xd = C.__errno_location)(),
							mc = (a) => (mc = C.__getTypeName)(a);
						k.__embind_initialize_bindings = () =>
							(k.__embind_initialize_bindings =
								C._embind_initialize_bindings)();
						k.dynCall_iiji = (a, b, c, d, e) =>
							(k.dynCall_iiji = C.dynCall_iiji)(a, b, c, d, e);
						k.dynCall_iiiji = (a, b, c, d, e, f) =>
							(k.dynCall_iiiji = C.dynCall_iiiji)(
								a,
								b,
								c,
								d,
						...
						k.dynCall_jii = (a, b, c) =>
							(k.dynCall_jii = C.dynCall_jii)(a, b, c);
						k.dynCall_vijj = (a, b, c, d, e, f) =>
							(k.dynCall_vijj = C.dynCall_vijj)(a, b, c, d, e, f);
						k.dynCall_jiji = (a, b, c, d, e) =>
							(k.dynCall_jiji = C.dynCall_jiji)(a, b, c, d, e);
						k.dynCall_viijii = (a, b, c, d, e, f, g) =>
							(k.dynCall_viijii = C.dynCall_viijii)(
								a,
								b,
								c,
								d,
						...
						k.dynCall_iiiiij = (a, b, c, d, e, f, g) =>
							(k.dynCall_iiiiij = C.dynCall_iiiiij)(
								a,
								b,
								c,
								d,
						...
						k.dynCall_iiiiijj = (a, b, c, d, e, f, g, l, p) =>
							(k.dynCall_iiiiijj = C.dynCall_iiiiijj)(
								a,
								b,
								c,
								d,
						...
						k.dynCall_iiiiiijj = (a, b, c, d, e, f, g, l, p, m) =>
							(k.dynCall_iiiiiijj = C.dynCall_iiiiiijj)(
								a,
								b,
								c,
								d,
							...
							function a() {
								if (
									...
									k.noFSInit ||
										...
										k.stdout
											? Vb("stdout", null, k.stdout)
											: Ob("/dev/tty", "/dev/stdout"),
										k.stderr
											? Vb("stderr", null, k.stderr)
			...
			/***/ (
				...
				var registerTouchInteractions = function (_a) {
					...
					var processEventCallback = function (event) {
						...
						var canvasCoordinatesVector = new rive.Vec2D(
							canvasX,
							canvasY,
						);
		...
		(() => {
			...
			/* harmony export */ __webpack_require__.d(__webpack_exports__, {
				...
				/* harmony export */ RiveEventType: () =>
					/* binding */ RiveEventType,
				/* harmony export */ RiveFile: () => /* binding */ RiveFile,
				/* harmony export */ RuntimeLoader: () =>
					/* binding */ RuntimeLoader,
				...
				/* harmony export */ decodeAudio: () =>
					/* binding */ decodeAudio,
				/* harmony export */ decodeFont: () => /* binding */ decodeFont,
				/* harmony export */ decodeImage: () =>
					/* binding */ decodeImage,
				/* harmony export */
			});
			...
			/* harmony import */ var _animation__WEBPACK_IMPORTED_MODULE_2__ =
					...
					return new Layout({
						...
						alignment:
							alignment !== null && alignment !== void 0
								...
								: this.alignment,
						layoutScaleFactor:
							layoutScaleFactor !== null &&
							layoutScaleFactor !== void 0
								? layoutScaleFactor
								: this.layoutScaleFactor,
						minX:
							minX !== null && minX !== void 0 ? minX : this.minX,
						minY:
							minY !== null && minY !== void 0 ? minY : this.minY,
						maxX:
							maxX !== null && maxX !== void 0 ? maxX : this.maxX,
						maxY:
							maxY !== null && maxY !== void 0 ? maxY : this.maxY,
					});
				};
					...
					_rive_advanced_mjs__WEBPACK_IMPORTED_MODULE_0__["default"]({
						...
						.then(function (rive) {
							...
							while (RuntimeLoader.callBackQueue.length > 0) {
								(_a = RuntimeLoader.callBackQueue.shift()) ===
									null || _a === void 0
									? void 0
						...
						.catch(function (error) {
							...
							console.debug(
								"Rive WASM load error details:",
								errorDetails,
							);
							// In case unpkg fails, or the wasm was not supported, we try to load the fallback module from jsdelivr.
							// This `rive_fallback.wasm` is compiled to support older architecture.
							// TODO: (Gordon): preemptively test browser support and load the correct wasm file. Then use jsdelvr only if unpkg fails.
							var backupJsdelivrUrl =
								"https://cdn.jsdelivr.net/npm/"
									.concat(
										package_json__WEBPACK_IMPORTED_MODULE_1__.name,
										"@",
									)
									.concat(
							...
							if (
								RuntimeLoader.wasmURL.toLowerCase() !==
								backupJsdelivrUrl
							) {
								console.warn(
			...
			var StateMachine = /** @class */ (function () {
				...
				Object.defineProperty(StateMachine.prototype, "statesChanged", {
					...
					get: function () {
						...
						for (
							...
							names.push(
								this.instance.stateChangedNameByIndex(i),
							);
						}
						return names;
					},
				 ...
				 * @param input
				 */
				StateMachine.prototype.mapRuntimeInput = function (
					input,
					runtime,
				) {
			...
			var Animator = /** @class */ (function () {
				...
				Animator.prototype.add = function (
					...
					if (animatables.length === 0) {
						...
						var instancedAnimationNames = this.animations.map(
							function (a) {
								return a.name;
							},
						);
						var instancedMachineNames = this.stateMachines.map(
							function (m) {
								return m.name;
							},
						);
						for (var i = 0; i < animatables.length; i++) {
							var aIndex = instancedAnimationNames.indexOf(
								animatables[i],
							);
							var mIndex = instancedMachineNames.indexOf(
								animatables[i],
							);
							if (aIndex >= 0 || mIndex >= 0) {
								if (aIndex >= 0) {
									...
									this.stateMachines[mIndex].playing =
										playing;
								}
							} else {
								// Try to create a new animation instance
								var anim = this.artboard.animationByName(
									animatables[i],
								);
								if (anim) {
									var newAnimation =
										new _animation__WEBPACK_IMPORTED_MODULE_2__.Animation(
											anim,
											this.artboard,
											this.runtime,
											playing,
									...
									var sm = this.artboard.stateMachineByName(
										animatables[i],
									);
									if (sm) {
				...
				Animator.prototype.initStateMachines = function (
					...
					// But given that it this is called during artboard initialization
					// it should probably be safe to remove.
					var instancedStateMachineNames = this.stateMachines.map(
						function (a) {
							return a.name;
						},
					);
					for (var i = 0; i < animatables.length; i++) {
						var aIndex = instancedStateMachineNames.indexOf(
							animatables[i],
						);
						if (aIndex >= 0) {
				...
				Animator.prototype.stop = function (animatables) {
					...
					if (animatables.length === 0) {
						...
						var animationsToRemove = this.animations.filter(
							function (a) {
								return animatables.includes(a.name);
							},
						);
						animationsToRemove.forEach(function (a) {
							a.cleanup();
							_this.animations.splice(
								_this.animations.indexOf(a),
								1,
							);
						});
						var machinesToRemove = this.stateMachines.filter(
							function (m) {
						...
						machinesToRemove.forEach(function (m) {
							m.cleanup();
							_this.stateMachines.splice(
								_this.stateMachines.indexOf(m),
								1,
							);
						});
				...
				Animator.prototype.handleStateChanges = function () {
					...
					for (
						...
						statesChanged.push.apply(
							statesChanged,
							stateMachine.statesChanged,
						);
					}
				...
				EventManager.prototype.remove = function (listener) {
					...
					for (var i = 0; i < this.listeners.length; i++) {
						...
						if (currentListener.type === listener.type) {
							if (
								currentListener.callback === listener.callback
							) {
			...
			(function (SystemAudioStatus) {
				SystemAudioStatus[(SystemAudioStatus["AVAILABLE"] = 0)] =
					"AVAILABLE";
			...
			var ObjectObservers = /** @class */ (function () {
				function ObjectObservers() {
					...
					this._resizeObserver = new MyResizeObserver(
						this._onObserved,
					);
				}
			...
			var RiveFile = /** @class */ (function () {
						...
						return __generator(this, function (_d) {
							switch (_d.label) {
								...
								case 2:
									...
									if (this.assetLoader) {
										loader =
											new this.runtime.CustomFileAssetLoader(
												{
													loadContents:
														this.assetLoader,
												},
				 ...
				 * undefined
				 */
				RiveFile.prototype.removeAllRiveEventListeners = function (
					type,
				) {
			...
			var Rive = /** @class */ (function () {
				function Rive(params) {
					...
					this.layout =
						(_a = params.layout) !== null && _a !== void 0
							? _a
							: new Layout();
					this.shouldDisableRiveListeners =
						!!params.shouldDisableRiveListeners;
				...
				Rive.prototype.init = function (_a) {
					...
					var startingStateMachineNames =
						mapToStringArray(stateMachines);
				...
				Rive.prototype.setupRiveListeners = function (
					...
					if (!this.shouldDisableRiveListeners) {
						var activeStateMachines = (
							this.animator.stateMachines || []
						)
							.filter(function (sm) {
								return (
									sm.playing &&
									_this.runtime.hasListeners(sm.instance)
								);
							})
							.map(function (sm) {
								return sm.instance;
							});
						var touchScrollEnabledOption =
				...
				Rive.prototype.initArtboard = function (
					...
					rootArtboard.volume =
						this._volume * audioManager.systemVolume;
					...
					if (
						...
						instanceNames =
							animationNames.concat(stateMachineNames);
						this.animator.initLinearAnimations(
							animationNames,
							autoplay,
						);
					...
					if (autoBind) {
						var viewModel =
							this.file.defaultArtboardViewModel(rootArtboard);
						if (viewModel !== null) {
				...
				Rive.prototype.draw = function (time, onSecond) {
					...
					// - Advance to the first frame even when autoplay is false
					var activeStateMachines =
						this.animator.stateMachines.filter(function (a) {
							return a.playing;
						});
					for (
						var _b = 0, activeStateMachines_1 = activeStateMachines;
						_b < activeStateMachines_1.length;
						_b++
					) {
						var stateMachine = activeStateMachines_1[_b];
						// Check for events before the current frame's state machine advance
						var numEventsReported =
						...
						if (numEventsReported) {
							for (var i = 0; i < numEventsReported; i++) {
								...
								if (event_1) {
									if (
										event_1.type === RiveEventType.OpenUrl
									) {
										this.eventManager.fire({
										...
										if (this.automaticallyHandleEvents) {
											...
											var _c = event_1,
												...
												target = _c.target;
											var sanitizedUrl = (0,
											_utils__WEBPACK_IMPORTED_MODULE_3__.sanitizeUrl)(
												url,
											);
											url &&
												newAnchorTag.setAttribute(
													"href",
													sanitizedUrl,
												);
											target &&
				 ...
				 */
				Rive.prototype.setTextRunValue = function (
					textRunName,
					textRunValue,
				) {
					var textRun = this.retrieveTextRun(textRunName);
				...
				Object.defineProperty(Rive.prototype, "animationNames", {
					...
					get: function () {
						...
						for (
							...
							animationNames.push(
								this.artboard.animationByIndex(i).name,
							);
						}
				...
				Object.defineProperty(Rive.prototype, "stateMachineNames", {
					...
					get: function () {
						...
						for (
							...
							stateMachineNames.push(
								this.artboard.stateMachineByIndex(i).name,
							);
						}
				...
				Rive.prototype.stateMachineInputs = function (name) {
					...
					var stateMachine = this.animator.stateMachines.find(
						function (m) {
							return m.name === name;
						},
					);
				...
				Rive.prototype.retrieveInputAtPath = function (name, path) {
					if (!name) {
						console.warn(
							"No input name provided for path '".concat(
								path,
								"'",
							),
						);
				...
				Rive.prototype.retrieveTextAtPath = function (name, path) {
					if (!name) {
						console.warn(
							"No text name provided for path '".concat(
								path,
								"'",
							),
						);
					...
					if (!path) {
						console.warn(
							"No path provided for text '".concat(name, "'"),
						);
						return;
					}
					if (!this.artboard) {
				 ...
				 */
				Rive.prototype.getTextRunValueAtPath = function (
					textName,
					path,
				) {
				...
				Object.defineProperty(Rive.prototype, "contents", {
					...
					get: function () {
						...
						for (var i = 0; i < this.file.artboardCount(); i++) {
							...
							for (
								var j = 0;
								j < artboard.animationCount();
								j++
							) {
								var animation = artboard.animationByIndex(j);
								artboardContents.animations.push(
									animation.name,
								);
							}
							for (
								var k = 0;
								k < artboard.stateMachineCount();
								k++
							) {
								var stateMachine =
									artboard.stateMachineByIndex(k);
				...
				Object.defineProperty(Rive.prototype, "volume", {
					...
					set: function (value) {
						this._volume = value;
						if (this.artboard) {
							this.artboard.volume =
								value * audioManager.systemVolume;
						}
					},
					enumerable: false,
					configurable: true,
				...
				Object.defineProperty(Rive.prototype, "artboardWidth", {
					...
					get: function () {
						...
						return (_a = this._artboardWidth) !== null &&
							_a !== void 0
							? _a
							: 0;
					},
				...
				Object.defineProperty(Rive.prototype, "artboardHeight", {
					...
					get: function () {
						...
						return (_a = this._artboardHeight) !== null &&
							_a !== void 0
							? _a
							: 0;
					},
				 ...
				 */
				Rive.prototype.bindViewModelInstance = function (
					viewModelInstance,
				) {
					var _a;
					if (this.artboard && !this.destroyed) {
						if (
							...
							(_a = this._viewModelInstance) === null ||
							_a === void 0
								? void 0
								: _a.cleanup();
							...
							if (this.animator.stateMachines.length > 0) {
								this.animator.stateMachines.forEach(
									function (stateMachine) {
										return stateMachine.bindViewModelInstance(
											viewModelInstance,
										);
									},
								);
				...
				Rive.prototype.defaultViewModel = function () {
					if (this.artboard) {
						var viewModel = this.file.defaultArtboardViewModel(
							this.artboard,
						);
						if (viewModel) {
							return new ViewModel(viewModel);
			...
			var ViewModelInstance = /** @class */ (function () {
				...
				ViewModelInstance.prototype.handleCallbacks = function () {
					if (this._propertiesWithCallbacks.length !== 0) {
						this._propertiesWithCallbacks.forEach(
							function (property) {
				...
				ViewModelInstance.prototype.removeFromPropertyCallbacks =
					function (property) {
						...
						if (this._propertiesWithCallbacks.includes(property)) {
							this._propertiesWithCallbacks =
								this._propertiesWithCallbacks.filter(
									function (prop) {
				...
				ViewModelInstance.prototype.propertyFromPath = function (
					path,
					type,
				) {
				...
				ViewModelInstance.prototype.propertyFromPathSegments =
					function (pathSegments, index, type) {
						var _a,
							_b,
							_c,
							_d,
						...
						if (index < pathSegments.length - 1) {
							var viewModelInstance =
								this.internalViewModelInstance(
									pathSegments[index],
								);
							if (viewModelInstance !== null) {
						...
						switch (type) {
							...
							case PropertyType.Color:
								instance =
									(_h =
										(_g = this._runtimeInstance) === null ||
										_g === void 0
											? void 0
											: _g.color(pathSegments[index])) !==
										null && _h !== void 0
										? _h
										: null;
								if (instance !== null) {
							...
							case PropertyType.Enum:
								instance =
									(_m =
										(_l = this._runtimeInstance) === null ||
										_l === void 0
											? void 0
											: _l.enum(pathSegments[index])) !==
										null && _m !== void 0
										? _m
										: null;
								if (instance !== null) {
							...
							case PropertyType.List:
								instance =
									(_p =
										(_o = this._runtimeInstance) === null ||
										_o === void 0
											? void 0
											: _o.list(pathSegments[index])) !==
										null && _p !== void 0
										? _p
										: null;
								if (instance !== null) {
				...
				ViewModelInstance.prototype.internalReplaceViewModel =
					function (name, value) {
						var _a;
						if (value.runtimeInstance !== null) {
							...
							if (result) {
								...
								var oldInstance_1 =
									this.internalViewModelInstance(name);
								if (oldInstance_1 !== null) {
									oldInstance_1.removeParent(this);
									if (
										this._children.includes(oldInstance_1)
									) {
										this._children = this._children.filter(
											function (child) {
				 ...
				 */
				ViewModelInstance.prototype.replaceViewModel = function (
					path,
					value,
				) {
					var _a;
			...
			var ViewModelInstanceList = /** @class */ (function (_super) {
				...
				Object.defineProperty(
					ViewModelInstanceList.prototype,
					"length",
					{
						get: function () {
				...
				ViewModelInstanceList.prototype.addInstance = function (
					instance,
				) {
				...
				ViewModelInstanceList.prototype.removeInstance = function (
					instance,
				) {
					if (instance.runtimeInstance != null) {
				...
				ViewModelInstanceList.prototype.removeInstanceAt = function (
					index,
				) {
				...
				ViewModelInstanceList.prototype.instanceAt = function (index) {
					var runtimeInstance =
						this._viewModelInstanceValue.instanceAt(index);
					if (runtimeInstance != null) {
						var viewModelInstance = new ViewModelInstance(
							runtimeInstance,
							null,
			...
			var ViewModelInstanceColor = /** @class */ (function (_super) {
				...
				Object.defineProperty(
					ViewModelInstanceColor.prototype,
					"value",
					{
						get: function () {
							return this._viewModelInstanceValue.value;
